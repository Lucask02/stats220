...
num_commuter <- mean(latest_data$`What is your type of transportation for commuting`, na.rm = TRUE)
...
(latest_data$`What is your type of trasportation for commuting`) %>% mean()
